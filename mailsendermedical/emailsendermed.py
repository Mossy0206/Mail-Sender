...
def import_spreadsheet(fn, ln, d):
    dt = pd.read_excel('/home/pi/Downloads/mailsendermedical/First_Aid_Refreshers.xlsx')
    ...
    if email_date.strftime("%d.%m.%Y") == date.today().strftime("%d.%m.%Y"):
        ...
        try:
            with smtplib.SMTP('smtp.gmail.com', 587) as smtp:
                print(1)
                subject = "First aid refresher course for: {Sname} {Lname}".format(Sname=Sname, Lname=Lname)
                ...
                while True:
                    try:
                        wb = openpyxl.load_workbook('/home/pi/Downloads/mailsendermedical/First_Aid_Refreshers.xlsx')
                        sheet = wb.active
                        ...
                        wb.save("/home/pi/Downloads/mailsendermedical/First_Aid_Refreshers.xlsx")
                        print("Excel Updated")
                        break
